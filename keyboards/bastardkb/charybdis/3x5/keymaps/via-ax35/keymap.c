...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_wrapper(BASE_LAYER),
  [FUN] = LAYOUT_wrapper(FUN_LAYER),
  [NUM] = LAYOUT_wrapper(NUM_LAYER),
  [NAV] = LAYOUT_wrapper(NAV_LAYER),
  [MOUSE] = LAYOUT_wrapper(MOUSE_LAYER),
  [MEDIA] = LAYOUT_wrapper(MEDIA_LAYER),
